...
class IdentityRecord extends DataClass implements Insertable<IdentityRecord> {
  ...
  @override
  int get hashCode => Object.hash(id, displayName, firstName, lastName, email,
      mobile, profilePic, cardColor, isPrimary);
  @override
...
abstract class _$IdentitiesDatabase extends GeneratedDatabase {
  ...
  late final $IdentitiesTableTable identitiesTable =
...
class $$IdentitiesTableTableTableManager extends RootTableManager<
    ...
    (
      IdentityRecord,
      BaseReferences<_$IdentitiesDatabase, $IdentitiesTableTable,
          IdentityRecord>
    ),
    IdentityRecord,
    PrefetchHooks Function()> {
  $$IdentitiesTableTableTableManager(
      _$IdentitiesDatabase db, $IdentitiesTableTable table)
...
typedef $$IdentitiesTableTableProcessedTableManager = ProcessedTableManager<
    _$IdentitiesDatabase,
    $IdentitiesTableTable,
    IdentityRecord,
    $$IdentitiesTableTableFilterComposer,
