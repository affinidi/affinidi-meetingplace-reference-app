...
switch (_that) {
case _ChatScreenState() when $default != null:
return $default(_that.contact,_that.group,_that.offerName,_that.otherPartyCard,_that.myCard,_that.messages,_that.latestSuggestion,_that.membersTyping,_that.selectedReactionIndex,_that.isActive,_that.isInitialized,_that.contactPresenceStatus,_that.effect,_that.attachmentsDataCache,_that.notificationToken,_that.myDid,_that.shouldEnableVrcAttachment,_that.shouldShowVrcBanner,_that.shouldStartVrcExchangeFromAttachment,_that.capabilities,_that.isCallSupported);case _:
  return orElse();
