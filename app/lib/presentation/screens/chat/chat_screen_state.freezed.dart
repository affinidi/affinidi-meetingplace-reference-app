...
@useResult
$Res call({
 Contact? contact, Group? group, String? offerName, ContactCard? otherPartyCard, List<chat.ChatItem> messages, List<String> membersTyping, int selectedReactionIndex, bool isActive, bool isInitialized, ContactPresenceStatus contactPresenceStatus, ScreenEffect? effect, Map<String, Uint8List> attachmentsDataCache, Set<String> failedAttachmentDownloads, String? notificationToken
});
...
as Map<String, Uint8List>,failedAttachmentDownloads: null == failedAttachmentDownloads ? _self.failedAttachmentDownloads : failedAttachmentDownloads // ignore: cast_nullable_to_non_nullable
as Set<String>,notificationToken: freezed == notificationToken ? _self.notificationToken : notificationToken // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of ChatScreenState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Contact? contact,  Group? group,  String? offerName,  ContactCard? otherPartyCard,  List<chat.ChatItem> messages,  List<String> membersTyping,  int selectedReactionIndex,  bool isActive,  bool isInitialized,  ContactPresenceStatus contactPresenceStatus,  ScreenEffect? effect,  Map<String, Uint8List> attachmentsDataCache,  Set<String> failedAttachmentDownloads,  String? notificationToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatScreenState() when $default != null:
return $default(_that.contact,_that.group,_that.offerName,_that.otherPartyCard,_that.messages,_that.membersTyping,_that.selectedReactionIndex,_that.isActive,_that.isInitialized,_that.contactPresenceStatus,_that.effect,_that.attachmentsDataCache,_that.failedAttachmentDownloads,_that.notificationToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Contact? contact,  Group? group,  String? offerName,  ContactCard? otherPartyCard,  List<chat.ChatItem> messages,  List<String> membersTyping,  int selectedReactionIndex,  bool isActive,  bool isInitialized,  ContactPresenceStatus contactPresenceStatus,  ScreenEffect? effect,  Map<String, Uint8List> attachmentsDataCache,  Set<String> failedAttachmentDownloads,  String? notificationToken)  $default,) {final _that = this;
switch (_that) {
case _ChatScreenState():
return $default(_that.contact,_that.group,_that.offerName,_that.otherPartyCard,_that.messages,_that.membersTyping,_that.selectedReactionIndex,_that.isActive,_that.isInitialized,_that.contactPresenceStatus,_that.effect,_that.attachmentsDataCache,_that.failedAttachmentDownloads,_that.notificationToken);case _:
  throw StateError('Unexpected subclass');
...
class _ChatScreenState extends ChatScreenState {
   _ChatScreenState({this.contact, this.group, this.offerName, this.otherPartyCard, final  List<chat.ChatItem> messages = const [], final  List<String> membersTyping = const [], this.selectedReactionIndex = -1, this.isActive = false, this.isInitialized = false, this.contactPresenceStatus = ContactPresenceStatus.unknown, this.effect, final  Map<String, Uint8List> attachmentsDataCache = const {}, final  Set<String> failedAttachmentDownloads = const {}, this.notificationToken}): _messages = messages,_membersTyping = membersTyping,_attachmentsDataCache = attachmentsDataCache,_failedAttachmentDownloads = failedAttachmentDownloads,super._();
...
@override@JsonKey() Map<String, Uint8List> get attachmentsDataCache {
 ...
 final  Set<String> _failedAttachmentDownloads;
@override@JsonKey() Set<String> get failedAttachmentDownloads {
  if (_failedAttachmentDownloads is EqualUnmodifiableSetView) return _failedAttachmentDownloads;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableSetView(_failedAttachmentDownloads);
}
...
as Map<String, Uint8List>,failedAttachmentDownloads: null == failedAttachmentDownloads ? _self._failedAttachmentDownloads : failedAttachmentDownloads // ignore: cast_nullable_to_non_nullable
as Set<String>,notificationToken: freezed == notificationToken ? _self.notificationToken : notificationToken // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
