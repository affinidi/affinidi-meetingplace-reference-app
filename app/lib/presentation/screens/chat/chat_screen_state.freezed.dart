...
@useResult
$Res call({
 Contact? contact, Group? group, String? offerName, ContactCard? otherPartyCard, List<chat.ChatItem> messages, List<String> membersTyping, int selectedReactionIndex, bool isActive, bool isInitialized, ContactPresenceStatus contactPresenceStatus, ScreenEffect? effect, Map<String, Uint8List> attachmentsDataCache, String? notificationToken, bool isFocusModeActive, String? agentSuggestion, bool isAgentThinking
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Contact? contact,  Group? group,  String? offerName,  ContactCard? otherPartyCard,  List<chat.ChatItem> messages,  List<String> membersTyping,  int selectedReactionIndex,  bool isActive,  bool isInitialized,  ContactPresenceStatus contactPresenceStatus,  ScreenEffect? effect,  Map<String, Uint8List> attachmentsDataCache,  String? notificationToken,  bool isFocusModeActive,  String? agentSuggestion,  bool isAgentThinking)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatScreenState() when $default != null:
return $default(_that.contact,_that.group,_that.offerName,_that.otherPartyCard,_that.messages,_that.membersTyping,_that.selectedReactionIndex,_that.isActive,_that.isInitialized,_that.contactPresenceStatus,_that.effect,_that.attachmentsDataCache,_that.notificationToken,_that.isFocusModeActive,_that.agentSuggestion,_that.isAgentThinking);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Contact? contact,  Group? group,  String? offerName,  ContactCard? otherPartyCard,  List<chat.ChatItem> messages,  List<String> membersTyping,  int selectedReactionIndex,  bool isActive,  bool isInitialized,  ContactPresenceStatus contactPresenceStatus,  ScreenEffect? effect,  Map<String, Uint8List> attachmentsDataCache,  String? notificationToken,  bool isFocusModeActive,  String? agentSuggestion,  bool isAgentThinking)  $default,) {final _that = this;
switch (_that) {
case _ChatScreenState():
return $default(_that.contact,_that.group,_that.offerName,_that.otherPartyCard,_that.messages,_that.membersTyping,_that.selectedReactionIndex,_that.isActive,_that.isInitialized,_that.contactPresenceStatus,_that.effect,_that.attachmentsDataCache,_that.notificationToken,_that.isFocusModeActive,_that.agentSuggestion,_that.isAgentThinking);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode => Object.hash(runtimeType,contact,group,offerName,otherPartyCard,const DeepCollectionEquality().hash(_messages),const DeepCollectionEquality().hash(_membersTyping),selectedReactionIndex,isActive,isInitialized,contactPresenceStatus,effect,const DeepCollectionEquality().hash(_attachmentsDataCache),notificationToken,isFocusModeActive,agentSuggestion,isAgentThinking);
