...
mixin _$ControlPlaneServiceState {
 ...
 bool get isProcessing; bool? get isDeviceTokenRegistered;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ControlPlaneServiceState&&(identical(other.isProcessing, isProcessing) || other.isProcessing == isProcessing)&&(identical(other.isDeviceTokenRegistered, isDeviceTokenRegistered) || other.isDeviceTokenRegistered == isDeviceTokenRegistered));
}


@override
int get hashCode => Object.hash(runtimeType,isProcessing,isDeviceTokenRegistered);
...
@useResult
$Res call({
 bool isProcessing, bool? isDeviceTokenRegistered
});
...
/// Create a copy of ControlPlaneServiceState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isProcessing = null,Object? isDeviceTokenRegistered = freezed,}) {
  return _then(_self.copyWith(
isProcessing: null == isProcessing ? _self.isProcessing : isProcessing // ignore: cast_nullable_to_non_nullable
as bool,isDeviceTokenRegistered: freezed == isDeviceTokenRegistered ? _self.isDeviceTokenRegistered : isDeviceTokenRegistered // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isProcessing,  bool? isDeviceTokenRegistered)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ControlPlaneServiceState() when $default != null:
return $default(_that.isProcessing,_that.isDeviceTokenRegistered);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isProcessing,  bool? isDeviceTokenRegistered)  $default,) {final _that = this;
switch (_that) {
case _ControlPlaneServiceState():
return $default(_that.isProcessing,_that.isDeviceTokenRegistered);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isProcessing,  bool? isDeviceTokenRegistered)?  $default,) {final _that = this;
switch (_that) {
case _ControlPlaneServiceState() when $default != null:
return $default(_that.isProcessing,_that.isDeviceTokenRegistered);case _:
  return null;
...
class _ControlPlaneServiceState implements ControlPlaneServiceState {
  const _ControlPlaneServiceState({this.isProcessing = false, this.isDeviceTokenRegistered});
  

@override@JsonKey() final  bool isProcessing;
@override final  bool? isDeviceTokenRegistered;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ControlPlaneServiceState&&(identical(other.isProcessing, isProcessing) || other.isProcessing == isProcessing)&&(identical(other.isDeviceTokenRegistered, isDeviceTokenRegistered) || other.isDeviceTokenRegistered == isDeviceTokenRegistered));
}
...
/// Create a copy of ControlPlaneServiceState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isProcessing = null,Object? isDeviceTokenRegistered = freezed,}) {
