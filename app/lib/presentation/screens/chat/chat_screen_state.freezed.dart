...
@useResult
$Res call({
 Contact? contact, Group? group, String? offerName, ContactCard? otherPartyCard, ContactCard? myCard, List<chat.ChatItem> messages, ChatSuggestion? latestSuggestion, String? pendingSuggestionMessageId, List<String> membersTyping, int selectedReactionIndex, bool isActive, bool isInitialized, ContactPresenceStatus contactPresenceStatus, ScreenEffect? effect, Map<String, Uint8List> attachmentsDataCache, String? notificationToken, String? myDid, bool shouldEnableVrcAttachment, bool isPersonalAgentReady, bool shouldShowVrcBanner, bool shouldStartVrcExchangeFromAttachment, chat.TransportCapabilities? capabilities, bool isCallSupported
});
...
as bool,isPersonalAgentReady: null == isPersonalAgentReady ? _self.isPersonalAgentReady : isPersonalAgentReady // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ChatScreenState() when $default != null:
return $default(_that.contact,_that.group,_that.offerName,_that.otherPartyCard,_that.myCard,_that.messages,_that.latestSuggestion,_that.pendingSuggestionMessageId,_that.membersTyping,_that.selectedReactionIndex,_that.isActive,_that.isInitialized,_that.contactPresenceStatus,_that.effect,_that.attachmentsDataCache,_that.notificationToken,_that.myDid,_that.shouldEnableVrcAttachment,_that.isPersonalAgentReady,_that.shouldShowVrcBanner,_that.shouldStartVrcExchangeFromAttachment,_that.capabilities,_that.isCallSupported);case _:
  return orElse();
...
@override@JsonKey() final  bool isPersonalAgentReady;
...
@override
int get hashCode => Object.hashAll([runtimeType,contact,group,offerName,otherPartyCard,myCard,const DeepCollectionEquality().hash(_messages),latestSuggestion,pendingSuggestionMessageId,const DeepCollectionEquality().hash(_membersTyping),selectedReactionIndex,isActive,isInitialized,contactPresenceStatus,effect,const DeepCollectionEquality().hash(_attachmentsDataCache),notificationToken,myDid,shouldEnableVrcAttachment,isPersonalAgentReady,shouldShowVrcBanner,shouldStartVrcExchangeFromAttachment,capabilities,isCallSupported]);
