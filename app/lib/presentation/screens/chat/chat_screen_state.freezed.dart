...
@override
int get hashCode => Object.hash(runtimeType,contact,group,offerName,otherPartyCard,const DeepCollectionEquality().hash(_messages),const DeepCollectionEquality().hash(_membersTyping),selectedReactionIndex,isActive,isInitialized,contactPresenceStatus,effect,const DeepCollectionEquality().hash(_attachmentsDataCache),notificationToken,shouldEnableVrcAttachment,shouldShowVrcBanner,shouldStartVrcExchangeFromAttachment);
