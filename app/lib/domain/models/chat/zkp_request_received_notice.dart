...
/// Represents a chat item that displays when user receives a liveness check request.
///
/// This class extends [chat.ChatItem] and shows a concierge message with action buttons.
