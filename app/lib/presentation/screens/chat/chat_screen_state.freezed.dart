...
@override
int get hashCode => Object.hash(runtimeType,contact,group,offerName,otherPartyCard,myCard,const DeepCollectionEquality().hash(messages),const DeepCollectionEquality().hash(membersTyping),selectedReactionIndex,isActive,isInitialized,contactPresenceStatus,effect,notificationToken,myDid,shouldEnableVrcAttachment,shouldShowVrcBanner,shouldStartVrcExchangeFromAttachment,capabilities);

@override
String toString() {
  return 'ChatScreenState(contact: $contact, group: $group, offerName: $offerName, otherPartyCard: $otherPartyCard, myCard: $myCard, messages: $messages, membersTyping: $membersTyping, selectedReactionIndex: $selectedReactionIndex, isActive: $isActive, isInitialized: $isInitialized, contactPresenceStatus: $contactPresenceStatus, effect: $effect, notificationToken: $notificationToken, myDid: $myDid, shouldEnableVrcAttachment: $shouldEnableVrcAttachment, shouldShowVrcBanner: $shouldShowVrcBanner, shouldStartVrcExchangeFromAttachment: $shouldStartVrcExchangeFromAttachment, capabilities: $capabilities)';
}
...
@useResult
$Res call({
 Contact? contact, Group? group, String? offerName, ContactCard? otherPartyCard, ContactCard? myCard, List<chat.ChatItem> messages, List<String> membersTyping, int selectedReactionIndex, bool isActive, bool isInitialized, ContactPresenceStatus contactPresenceStatus, ScreenEffect? effect, String? notificationToken, String? myDid, bool shouldEnableVrcAttachment, bool shouldShowVrcBanner, bool shouldStartVrcExchangeFromAttachment, chat.TransportCapabilities? capabilities
});
...
as ScreenEffect?,notificationToken: freezed == notificationToken ? _self.notificationToken : notificationToken // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ChatScreenState() when $default != null:
return $default(_that.contact,_that.group,_that.offerName,_that.otherPartyCard,_that.myCard,_that.messages,_that.membersTyping,_that.selectedReactionIndex,_that.isActive,_that.isInitialized,_that.contactPresenceStatus,_that.effect,_that.notificationToken,_that.myDid,_that.shouldEnableVrcAttachment,_that.shouldShowVrcBanner,_that.shouldStartVrcExchangeFromAttachment,_that.capabilities);case _:
  return orElse();
...
class _ChatScreenState extends ChatScreenState {
   _ChatScreenState({this.contact, this.group, this.offerName, this.otherPartyCard, this.myCard, final  List<chat.ChatItem> messages = const [], final  List<String> membersTyping = const [], this.selectedReactionIndex = -1, this.isActive = false, this.isInitialized = false, this.contactPresenceStatus = ContactPresenceStatus.unknown, this.effect, this.notificationToken, this.myDid, this.shouldEnableVrcAttachment = false, this.shouldShowVrcBanner = false, this.shouldStartVrcExchangeFromAttachment = false, this.capabilities}): _messages = messages,_membersTyping = membersTyping,super._();
...
@override
int get hashCode => Object.hash(runtimeType,contact,group,offerName,otherPartyCard,myCard,const DeepCollectionEquality().hash(_messages),const DeepCollectionEquality().hash(_membersTyping),selectedReactionIndex,isActive,isInitialized,contactPresenceStatus,effect,notificationToken,myDid,shouldEnableVrcAttachment,shouldShowVrcBanner,shouldStartVrcExchangeFromAttachment,capabilities);
