...
mixin _$AcceptOfferScreenState {
  ...
  $AcceptOfferScreenStateCopyWith<AcceptOfferScreenState> get copyWith =>
      _$AcceptOfferScreenStateCopyWithImpl<AcceptOfferScreenState>(
          this as AcceptOfferScreenState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AcceptOfferScreenState &&
  ...
  @override
  int get hashCode => Object.hash(runtimeType, offer, error, selectedIdentity,
...
abstract mixin class $AcceptOfferScreenStateCopyWith<$Res> {
  factory $AcceptOfferScreenStateCopyWith(AcceptOfferScreenState value,
          $Res Function(AcceptOfferScreenState) _then) =
      _$AcceptOfferScreenStateCopyWithImpl;
  @useResult
  $Res call(
...
extension AcceptOfferScreenStatePatterns on AcceptOfferScreenState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AcceptOfferScreenState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(ConnectionOffer? offer, String? error,
            Identity? selectedIdentity, List<Identity> identities)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AcceptOfferScreenState() when $default != null:
        return $default(
            _that.offer, _that.error, _that.selectedIdentity, _that.identities);
      case _:
        return orElse();
    }
  }
...
class _AcceptOfferScreenState implements AcceptOfferScreenState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AcceptOfferScreenStateCopyWith<_AcceptOfferScreenState> get copyWith =>
      __$AcceptOfferScreenStateCopyWithImpl<_AcceptOfferScreenState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AcceptOfferScreenState &&
            (identical(other.offer, offer) || other.offer == offer) &&
            (identical(other.error, error) || other.error == error) &&
            (identical(other.selectedIdentity, selectedIdentity) ||
                other.selectedIdentity == selectedIdentity) &&
...
/// @nodoc
abstract mixin class _$AcceptOfferScreenStateCopyWith<$Res>
    implements $AcceptOfferScreenStateCopyWith<$Res> {
  factory _$AcceptOfferScreenStateCopyWith(_AcceptOfferScreenState value,
          $Res Function(_AcceptOfferScreenState) _then) =
      __$AcceptOfferScreenStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {ConnectionOffer? offer,
