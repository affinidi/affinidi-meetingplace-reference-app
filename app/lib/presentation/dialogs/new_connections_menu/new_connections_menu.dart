...
class NewConnectionsMenu extends StatelessWidget {
  ...
  static Future<NewConnectionsMenuOption?> show({
    ...
    useSafeArea: true,
    context: context,
    builder: (context) => NewConnectionsMenu(currentIdentity: currentIdentity),
  );
  ...
  static void _showConnectionSuccessBottomSheet(
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ConnectionSuccessBottomSheet.show(context: context, channel: channel);
    });
  }

  static Future<void> _oobScanQrCode({required BuildContext context}) async {
  ...
  static Future<void> _oobShareQrCode({required BuildContext context}) async {
