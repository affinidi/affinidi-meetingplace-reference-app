...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get signDocumentRequiresAgentSetup =>
      'Para usar Firmar documento, ve a la pestaña Agente y completa la configuración.';
  ...
  String agentReplyInfo(String senderName, String time) {
    return 'respuesta del agente de $senderName a las $time';
  }
  ...
  String personalAgentCancelConnectionTitle(String label) {
    return '¿Eliminar definitivamente la conexión de $label?';
  }

  @override
  String personalAgentCancelConnectionContent(String agentLabel) {
    return '¿Seguro que quieres eliminar definitivamente tu conexión con el $agentLabel? No podrás volver a conectarte.';
  }
  ...
  @override
  String get personalAgentCancelConnection => 'Eliminar conexión';

  @override
  String personalAgentConnectionCancelled(String label) {
    return 'Conexión de $label eliminada definitivamente.';
  }

  @override
  String personalAgentCancelConnectionError(String label) {
    return 'No se pudo eliminar definitivamente la conexión de $label.';
  }
  ...
  @override
  String get groupCallWaitingForOthers => 'Esperando a otros...';

  @override
  String get groupCallParticipant => 'participante';

  @override
  String get groupCallParticipants => 'participantes';

  @override
  String get groupCallEndCall => 'Finalizar llamada';

  @override
  String get groupCallNoParticipants => 'Sin participantes';
  ...
  @override
  String get callParticipantsConnectedSection => 'Conectados';

  @override
  String get callParticipantsNotConnectedSection => 'No conectados';
