...
mixin _$CameraServiceState {
 ...
 List<CameraDescription> get cameras; bool? get isAvailable; CameraController? get controller; bool get permissionGranted;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CameraServiceState&&const DeepCollectionEquality().equals(other.cameras, cameras)&&(identical(other.isAvailable, isAvailable) || other.isAvailable == isAvailable)&&(identical(other.controller, controller) || other.controller == controller)&&(identical(other.permissionGranted, permissionGranted) || other.permissionGranted == permissionGranted));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(cameras),isAvailable,controller,permissionGranted);
...
@useResult
$Res call({
 List<CameraDescription> cameras, bool? isAvailable, CameraController? controller, bool permissionGranted
});
...
/// Create a copy of CameraServiceState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? cameras = null,Object? isAvailable = freezed,Object? controller = freezed,Object? permissionGranted = null,}) {
...
as CameraController?,permissionGranted: null == permissionGranted ? _self.permissionGranted : permissionGranted // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<CameraDescription> cameras,  bool? isAvailable,  CameraController? controller,  bool permissionGranted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CameraServiceState() when $default != null:
return $default(_that.cameras,_that.isAvailable,_that.controller,_that.permissionGranted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<CameraDescription> cameras,  bool? isAvailable,  CameraController? controller,  bool permissionGranted)  $default,) {final _that = this;
switch (_that) {
case _CameraServiceState():
return $default(_that.cameras,_that.isAvailable,_that.controller,_that.permissionGranted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<CameraDescription> cameras,  bool? isAvailable,  CameraController? controller,  bool permissionGranted)?  $default,) {final _that = this;
switch (_that) {
case _CameraServiceState() when $default != null:
return $default(_that.cameras,_that.isAvailable,_that.controller,_that.permissionGranted);case _:
  return null;
...
class _CameraServiceState implements CameraServiceState {
   _CameraServiceState({final  List<CameraDescription> cameras = const [], this.isAvailable, this.controller, this.permissionGranted = true}): _cameras = cameras;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CameraServiceState&&const DeepCollectionEquality().equals(other._cameras, _cameras)&&(identical(other.isAvailable, isAvailable) || other.isAvailable == isAvailable)&&(identical(other.controller, controller) || other.controller == controller)&&(identical(other.permissionGranted, permissionGranted) || other.permissionGranted == permissionGranted));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_cameras),isAvailable,controller,permissionGranted);
...
/// Create a copy of CameraServiceState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? cameras = null,Object? isAvailable = freezed,Object? controller = freezed,Object? permissionGranted = null,}) {
