...
mixin _$IdentitiesScreenState {
  ...
  IdentitiesScreenFilter get filter;
  Identity? get currentIdentity;
  List<Identity> get identities;
  bool get shouldSetupPrimaryIdentity;

  /// Create a copy of IdentitiesScreenState
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $IdentitiesScreenStateCopyWith<IdentitiesScreenState> get copyWith =>
      _$IdentitiesScreenStateCopyWithImpl<IdentitiesScreenState>(
          this as IdentitiesScreenState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IdentitiesScreenState &&
            ...
            (identical(other.shouldSetupPrimaryIdentity,
                    shouldSetupPrimaryIdentity) ||
                other.shouldSetupPrimaryIdentity ==
                    shouldSetupPrimaryIdentity));
  }
...
abstract mixin class $IdentitiesScreenStateCopyWith<$Res> {
  factory $IdentitiesScreenStateCopyWith(IdentitiesScreenState value,
          $Res Function(IdentitiesScreenState) _then) =
      _$IdentitiesScreenStateCopyWithImpl;
  @useResult
  $Res call(
      {bool shouldShowFilter,
      IdentitiesScreenFilter filter,
      Identity? currentIdentity,
      List<Identity> identities,
      bool shouldSetupPrimaryIdentity});
...
class _$IdentitiesScreenStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? shouldSetupPrimaryIdentity = null,
  }) {
    return _then(_self.copyWith(
      ...
      identities: null == identities
          ...
          : identities // ignore: cast_nullable_to_non_nullable
              as List<Identity>,
      shouldSetupPrimaryIdentity: null == shouldSetupPrimaryIdentity
          ? _self.shouldSetupPrimaryIdentity
          : shouldSetupPrimaryIdentity // ignore: cast_nullable_to_non_nullable
              as bool,
    ));
  }
...
extension IdentitiesScreenStatePatterns on IdentitiesScreenState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_IdentitiesScreenState value)? $default, {
    ...
    switch (_that) {
      case _IdentitiesScreenState() when $default != null:
        return $default(
            ...
            _that.filter,
            _that.currentIdentity,
            _that.identities,
            _that.shouldSetupPrimaryIdentity);
      case _:
        return orElse();
    }
  }
...
class _IdentitiesScreenState extends IdentitiesScreenState {
  _IdentitiesScreenState(
      ...
      this.filter = IdentitiesScreenFilter.all,
      this.currentIdentity,
      final List<Identity> identities = const [],
      this.shouldSetupPrimaryIdentity = false})
  ...
  @override
  @JsonKey()
  final IdentitiesScreenFilter filter;
  @override
  ...
  @override
  @JsonKey()
  final bool shouldSetupPrimaryIdentity;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$IdentitiesScreenStateCopyWith<_IdentitiesScreenState> get copyWith =>
      __$IdentitiesScreenStateCopyWithImpl<_IdentitiesScreenState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IdentitiesScreenState &&
            (identical(other.shouldShowFilter, shouldShowFilter) ||
                other.shouldShowFilter == shouldShowFilter) &&
            (identical(other.filter, filter) || other.filter == filter) &&
            (identical(other.currentIdentity, currentIdentity) ||
...
/// @nodoc
abstract mixin class _$IdentitiesScreenStateCopyWith<$Res>
    implements $IdentitiesScreenStateCopyWith<$Res> {
  factory _$IdentitiesScreenStateCopyWith(_IdentitiesScreenState value,
          $Res Function(_IdentitiesScreenState) _then) =
      __$IdentitiesScreenStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool shouldShowFilter,
