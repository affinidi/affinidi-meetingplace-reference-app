...
mixin _$MediaScreenState {
 ...
 Uint8List? get pickedImageBytes; bool get isCameraAvailable; CameraController? get cameraController; bool get isFrontCamera; bool get isLoading; bool get permissionGranted; int? get videoTooLargeMaxMb; bool get unsupportedFileType;
...
@useResult
$Res call({
 Uint8List? pickedImageBytes, bool isCameraAvailable, CameraController? cameraController, bool isFrontCamera, bool isLoading, bool permissionGranted, int? videoTooLargeMaxMb, bool unsupportedFileType
});
...
/// Create a copy of MediaScreenState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pickedImageBytes = freezed,Object? isCameraAvailable = null,Object? cameraController = freezed,Object? isFrontCamera = null,Object? isLoading = null,Object? permissionGranted = null,Object? videoTooLargeMaxMb = freezed,Object? unsupportedFileType = null,}) {
...
as int?,unsupportedFileType: null == unsupportedFileType ? _self.unsupportedFileType : unsupportedFileType // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Uint8List? pickedImageBytes,  bool isCameraAvailable,  CameraController? cameraController,  bool isFrontCamera,  bool isLoading,  bool permissionGranted,  int? videoTooLargeMaxMb,  bool unsupportedFileType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MediaScreenState() when $default != null:
return $default(_that.pickedImageBytes,_that.isCameraAvailable,_that.cameraController,_that.isFrontCamera,_that.isLoading,_that.permissionGranted,_that.videoTooLargeMaxMb,_that.unsupportedFileType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Uint8List? pickedImageBytes,  bool isCameraAvailable,  CameraController? cameraController,  bool isFrontCamera,  bool isLoading,  bool permissionGranted,  int? videoTooLargeMaxMb,  bool unsupportedFileType)  $default,) {final _that = this;
switch (_that) {
case _MediaScreenState():
return $default(_that.pickedImageBytes,_that.isCameraAvailable,_that.cameraController,_that.isFrontCamera,_that.isLoading,_that.permissionGranted,_that.videoTooLargeMaxMb,_that.unsupportedFileType);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Uint8List? pickedImageBytes,  bool isCameraAvailable,  CameraController? cameraController,  bool isFrontCamera,  bool isLoading,  bool permissionGranted,  int? videoTooLargeMaxMb,  bool unsupportedFileType)?  $default,) {final _that = this;
switch (_that) {
case _MediaScreenState() when $default != null:
return $default(_that.pickedImageBytes,_that.isCameraAvailable,_that.cameraController,_that.isFrontCamera,_that.isLoading,_that.permissionGranted,_that.videoTooLargeMaxMb,_that.unsupportedFileType);case _:
  return null;
...
class _MediaScreenState extends MediaScreenState {
   _MediaScreenState({this.pickedImageBytes, this.isCameraAvailable = false, this.cameraController, this.isFrontCamera = false, this.isLoading = false, this.permissionGranted = true, this.videoTooLargeMaxMb, this.unsupportedFileType = false}): super._();
...
@override@JsonKey() final  bool unsupportedFileType;
...
/// Create a copy of MediaScreenState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pickedImageBytes = freezed,Object? isCameraAvailable = null,Object? cameraController = freezed,Object? isFrontCamera = null,Object? isLoading = null,Object? permissionGranted = null,Object? videoTooLargeMaxMb = freezed,Object? unsupportedFileType = null,}) {
