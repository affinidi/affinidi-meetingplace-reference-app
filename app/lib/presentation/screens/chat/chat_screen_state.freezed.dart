...
@useResult
$Res call({
 Contact? contact, Group? group, String? offerName, ContactCard? otherPartyCard, List<chat.ChatItem> messages, List<String> membersTyping, int selectedReactionIndex, bool isActive, bool isInitialized, ContactPresenceStatus contactPresenceStatus, ScreenEffect? effect, Map<String, Uint8List> attachmentsDataCache, String? notificationToken, bool isFocusModeActive, String? agentSuggestion, bool isAgentThinking, List<String> agentSentMessageIds
});
...
as String?,isFocusModeActive: null == isFocusModeActive ? _self.isFocusModeActive : isFocusModeActive // ignore: cast_nullable_to_non_nullable
as bool,agentSuggestion: freezed == agentSuggestion ? _self.agentSuggestion : agentSuggestion // ignore: cast_nullable_to_non_nullable
as String?,isAgentThinking: null == isAgentThinking ? _self.isAgentThinking : isAgentThinking // ignore: cast_nullable_to_non_nullable
as bool,agentSentMessageIds: null == agentSentMessageIds ? _self.agentSentMessageIds : agentSentMessageIds // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
/// Create a copy of ChatScreenState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Contact? contact,  Group? group,  String? offerName,  ContactCard? otherPartyCard,  List<chat.ChatItem> messages,  List<String> membersTyping,  int selectedReactionIndex,  bool isActive,  bool isInitialized,  ContactPresenceStatus contactPresenceStatus,  ScreenEffect? effect,  Map<String, Uint8List> attachmentsDataCache,  String? notificationToken,  bool isFocusModeActive,  String? agentSuggestion,  bool isAgentThinking,  List<String> agentSentMessageIds)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatScreenState() when $default != null:
return $default(_that.contact,_that.group,_that.offerName,_that.otherPartyCard,_that.messages,_that.membersTyping,_that.selectedReactionIndex,_that.isActive,_that.isInitialized,_that.contactPresenceStatus,_that.effect,_that.attachmentsDataCache,_that.notificationToken,_that.isFocusModeActive,_that.agentSuggestion,_that.isAgentThinking,_that.agentSentMessageIds);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Contact? contact,  Group? group,  String? offerName,  ContactCard? otherPartyCard,  List<chat.ChatItem> messages,  List<String> membersTyping,  int selectedReactionIndex,  bool isActive,  bool isInitialized,  ContactPresenceStatus contactPresenceStatus,  ScreenEffect? effect,  Map<String, Uint8List> attachmentsDataCache,  String? notificationToken,  bool isFocusModeActive,  String? agentSuggestion,  bool isAgentThinking,  List<String> agentSentMessageIds)  $default,) {final _that = this;
switch (_that) {
case _ChatScreenState():
return $default(_that.contact,_that.group,_that.offerName,_that.otherPartyCard,_that.messages,_that.membersTyping,_that.selectedReactionIndex,_that.isActive,_that.isInitialized,_that.contactPresenceStatus,_that.effect,_that.attachmentsDataCache,_that.notificationToken,_that.isFocusModeActive,_that.agentSuggestion,_that.isAgentThinking,_that.agentSentMessageIds);case _:
  throw StateError('Unexpected subclass');
...
class _ChatScreenState extends ChatScreenState {
   _ChatScreenState({this.contact, this.group, this.offerName, this.otherPartyCard, final  List<chat.ChatItem> messages = const [], final  List<String> membersTyping = const [], this.selectedReactionIndex = -1, this.isActive = false, this.isInitialized = false, this.contactPresenceStatus = ContactPresenceStatus.unknown, this.effect, final  Map<String, Uint8List> attachmentsDataCache = const {}, this.notificationToken, this.isFocusModeActive = false, this.agentSuggestion, this.isAgentThinking = false, final  List<String> agentSentMessageIds = const []}): _messages = messages,_membersTyping = membersTyping,_attachmentsDataCache = attachmentsDataCache,_agentSentMessageIds = agentSentMessageIds,super._();
...
@override@JsonKey() final  bool isFocusModeActive;
@override final  String? agentSuggestion;
@override@JsonKey() final  bool isAgentThinking;
 final  List<String> _agentSentMessageIds;
@override@JsonKey() List<String> get agentSentMessageIds {
  if (_agentSentMessageIds is EqualUnmodifiableListView) return _agentSentMessageIds;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_agentSentMessageIds);
}
...
as bool,agentSuggestion: freezed == agentSuggestion ? _self.agentSuggestion : agentSuggestion // ignore: cast_nullable_to_non_nullable
as String?,isAgentThinking: null == isAgentThinking ? _self.isAgentThinking : isAgentThinking // ignore: cast_nullable_to_non_nullable
as bool,agentSentMessageIds: null == agentSentMessageIds ? _self._agentSentMessageIds : agentSentMessageIds // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
