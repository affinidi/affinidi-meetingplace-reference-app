...
as chat.TransportCapabilities?,voicePlayback: null == voicePlayback ? _self.voicePlayback : voicePlayback // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  VoicePlaybackState voicePlayback;
...
@override
int get hashCode => Object.hashAll([runtimeType,contact,group,offerName,otherPartyCard,myCard,const DeepCollectionEquality().hash(_messages),const DeepCollectionEquality().hash(_membersTyping),selectedReactionIndex,isActive,isInitialized,contactPresenceStatus,effect,const DeepCollectionEquality().hash(_attachmentsDataCache),notificationToken,myDid,shouldEnableVrcAttachment,shouldShowVrcBanner,shouldStartVrcExchangeFromAttachment,capabilities,voicePlayback]);
