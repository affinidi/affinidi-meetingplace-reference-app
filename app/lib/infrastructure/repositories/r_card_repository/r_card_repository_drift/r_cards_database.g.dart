...
part of 'r_cards_database.dart';

// ignore_for_file: type=lint
class $RCardsTable extends RCards with TableInfo<$RCardsTable, RCardRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $RCardsTable(this.attachedDatabase, [this._alias]);
  ...
  static const VerificationMeta _contactChannelDidMeta = const VerificationMeta(
    'contactChannelDid',
  );
  @override
  ...
  static const String $name = 'r_cards';
  @override
  ...
  RCardRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return RCardRow(
      ...
      contactChannelDid: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}contact_channel_did'],
      ),
  ...
  @override
  $RCardsTable createAlias(String alias) {
    return $RCardsTable(attachedDatabase, alias);
  }
}
...
class RCardRow extends DataClass implements Insertable<RCardRow> {
  ...
  RCardsCompanion toCompanion(bool nullToAbsent) {
    return RCardsCompanion(
  ...
  factory RCardRow.fromJson(
    ...
    return RCardRow(
      ...
      contactChannelDid: serializer.fromJson<String?>(
        json['contactChannelDid'],
      ),
  ...
  RCardRow copyWithCompanion(RCardsCompanion data) {
    return RCardRow(
...
class RCardsCompanion extends UpdateCompanion<RCardRow> {
  ...
  @override
  String toString() {
    return (StringBuffer('RCardsCompanion(')
          ..write('subjectDid: $subjectDid, ')
          ..write('vcBlob: $vcBlob, ')
          ..write('issuerDid: $issuerDid, ')
          ..write('version: $version, ')
...
abstract class _$RCardsDatabase extends GeneratedDatabase {
  _$RCardsDatabase(QueryExecutor e) : super(e);
  $RCardsDatabaseManager get managers => $RCardsDatabaseManager(this);
  late final $RCardsTable rCards = $RCardsTable(this);
  @override
  Iterable<TableInfo<Table, Object?>> get allTables =>
      allSchemaEntities.whereType<TableInfo<Table, Object?>>();
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [rCards];
}

typedef $$RCardsTableCreateCompanionBuilder =
    RCardsCompanion Function({
      required String subjectDid,
      required String vcBlob,
      required String issuerDid,
      Value<int> version,
...
typedef $$RCardsTableUpdateCompanionBuilder =
    RCardsCompanion Function({
      Value<String> subjectDid,
      Value<String> vcBlob,
      Value<String> issuerDid,
...
class $$RCardsTableFilterComposer
    extends Composer<_$RCardsDatabase, $RCardsTable> {
  $$RCardsTableFilterComposer({
    required super.$db,
...
class $$RCardsTableOrderingComposer
    extends Composer<_$RCardsDatabase, $RCardsTable> {
  $$RCardsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$RCardsTableAnnotationComposer
    extends Composer<_$RCardsDatabase, $RCardsTable> {
  $$RCardsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$RCardsTableTableManager
    extends
        RootTableManager<
          ...
          $$RCardsTableOrderingComposer,
          $$RCardsTableAnnotationComposer,
          $$RCardsTableCreateCompanionBuilder,
          $$RCardsTableUpdateCompanionBuilder,
          (RCardRow, BaseReferences<_$RCardsDatabase, $RCardsTable, RCardRow>),
          RCardRow,
          PrefetchHooks Function()
        > {
  $$RCardsTableTableManager(_$RCardsDatabase db, $RCardsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$RCardsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$RCardsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$RCardsTableAnnotationComposer($db: db, $table: table),
...
typedef $$RCardsTableProcessedTableManager =
...
class $RCardsDatabaseManager {
  final _$RCardsDatabase _db;
  $RCardsDatabaseManager(this._db);
  $$RCardsTableTableManager get rCards =>
      $$RCardsTableTableManager(_db, _db.rCards);
}
