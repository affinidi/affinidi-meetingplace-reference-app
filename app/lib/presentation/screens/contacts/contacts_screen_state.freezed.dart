...
mixin _$ContactsScreenState {
  bool get isEditMode;
  bool get shouldShowGrid;
  bool get shouldShowFilter;
  List<Contact> get contacts;
  List<Contact> get selectedContacts;
  Map<String, Mediator> get contactMediators;
  ContactsScreenFilter get filter;
  ...
  $ContactsScreenStateCopyWith<ContactsScreenState> get copyWith =>
      _$ContactsScreenStateCopyWithImpl<ContactsScreenState>(
          this as ContactsScreenState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ContactsScreenState &&
            (identical(other.isEditMode, isEditMode) ||
                other.isEditMode == isEditMode) &&
            (identical(other.shouldShowGrid, shouldShowGrid) ||
                other.shouldShowGrid == shouldShowGrid) &&
            (identical(other.shouldShowFilter, shouldShowFilter) ||
                other.shouldShowFilter == shouldShowFilter) &&
            const DeepCollectionEquality().equals(other.contacts, contacts) &&
            const DeepCollectionEquality()
                .equals(other.selectedContacts, selectedContacts) &&
            const DeepCollectionEquality()
                .equals(other.contactMediators, contactMediators) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(contactMediators),
      filter,
      identity);
...
abstract mixin class $ContactsScreenStateCopyWith<$Res> {
  factory $ContactsScreenStateCopyWith(
          ContactsScreenState value, $Res Function(ContactsScreenState) _then) =
      _$ContactsScreenStateCopyWithImpl;
  @useResult
  $Res call(
      {bool isEditMode,
      bool shouldShowGrid,
      ...
      Map<String, Mediator> contactMediators,
      ContactsScreenFilter filter,
      Identity? identity});
...
class _$ContactsScreenStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? shouldShowGrid = null,
    Object? shouldShowFilter = null,
    Object? contacts = null,
    Object? selectedContacts = null,
    Object? contactMediators = null,
    Object? filter = null,
    ...
    return _then(_self.copyWith(
      isEditMode: null == isEditMode
          ...
          : isEditMode // ignore: cast_nullable_to_non_nullable
              as bool,
      shouldShowGrid: null == shouldShowGrid
          ? _self.shouldShowGrid
          : shouldShowGrid // ignore: cast_nullable_to_non_nullable
              as bool,
      shouldShowFilter: null == shouldShowFilter
          ? _self.shouldShowFilter
          : shouldShowFilter // ignore: cast_nullable_to_non_nullable
              as bool,
      ...
      selectedContacts: null == selectedContacts
          ? _self.selectedContacts
          : selectedContacts // ignore: cast_nullable_to_non_nullable
              as List<Contact>,
      contactMediators: null == contactMediators
          ? _self.contactMediators
          : contactMediators // ignore: cast_nullable_to_non_nullable
              as Map<String, Mediator>,
      filter: null == filter
          ? _self.filter
          : filter // ignore: cast_nullable_to_non_nullable
              as ContactsScreenFilter,
...
extension ContactsScreenStatePatterns on ContactsScreenState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ContactsScreenState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ContactsScreenState() when $default != null:
        return $default(
            _that.isEditMode,
            _that.shouldShowGrid,
            _that.shouldShowFilter,
            _that.contacts,
            _that.selectedContacts,
            _that.contactMediators,
            _that.filter,
            _that.identity);
      case _:
        return orElse();
...
class _ContactsScreenState extends ContactsScreenState {
  _ContactsScreenState(
      ...
      final Map<String, Mediator> contactMediators = const {},
      this.filter = ContactsScreenFilter.any,
      this.identity})
      : _contacts = contacts,
        _selectedContacts = selectedContacts,
        _contactMediators = contactMediators,
        super._();
  ...
  @override
  @JsonKey()
  final ContactsScreenFilter filter;
  @override
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ContactsScreenStateCopyWith<_ContactsScreenState> get copyWith =>
      __$ContactsScreenStateCopyWithImpl<_ContactsScreenState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._contactMediators, _contactMediators) &&
            (identical(other.filter, filter) || other.filter == filter) &&
            (identical(other.identity, identity) ||
                other.identity == identity));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_contactMediators),
      filter,
      identity);
...
/// @nodoc
abstract mixin class _$ContactsScreenStateCopyWith<$Res>
    implements $ContactsScreenStateCopyWith<$Res> {
  factory _$ContactsScreenStateCopyWith(_ContactsScreenState value,
          $Res Function(_ContactsScreenState) _then) =
      __$ContactsScreenStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool isEditMode,
    ...
    return _then(_ContactsScreenState(
      ...
      contacts: null == contacts
          ...
          : contacts // ignore: cast_nullable_to_non_nullable
              as List<Contact>,
      selectedContacts: null == selectedContacts
          ? _self._selectedContacts
          : selectedContacts // ignore: cast_nullable_to_non_nullable
              as List<Contact>,
      contactMediators: null == contactMediators
          ? _self._contactMediators
          : contactMediators // ignore: cast_nullable_to_non_nullable
              as Map<String, Mediator>,
      filter: null == filter
          ? _self.filter
